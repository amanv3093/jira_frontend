...
export default function SettingsPage() {
  ...
  // Check if current logged-in user is the workspace owner
                ...
                return (
                  ...
                  >
                    ...
                    <div className="flex items-center gap-2 shrink-0">
                      {/* Role dropdown (only if current user is owner and this member is not owner) */}
                      {currentUserIsOwner && !isOwnerMember ? (
                        <DropdownMenu>
                      ...
                      {/* Remove button (only if owner and not self) */}
                      {currentUserIsOwner && !isOwnerMember && (
                        <DropdownMenu>
                          <DropdownMenuTrigger asChild>
                            <Button
