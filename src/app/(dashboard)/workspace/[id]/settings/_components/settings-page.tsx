...
import { useSubscriptionStatus, useCreateCheckout, useCreatePortalSession } from "@/hooks/subscription";
...
export default function SettingsPage() {
  ...
  const { data: billing } = useSubscriptionStatus(workspaceId);
            ...
            <div className="space-y-2">
              <div className="flex items-center justify-between text-sm">
                ...
                <span className="font-medium">
                  {billing.currentMembers} / {billing.plan === "PRO" ? "Unlimited" : billing.maxMembers}
                </span>
              </div>
              {billing.plan !== "PRO" && (
                  ...
                  <div
                    className={`h-full rounded-full transition-all duration-500 ${
                      billing.currentMembers / billing.maxMembers >= 0.8
                        ? "bg-amber-500"
                        : "bg-blue-500"
                    } ${billing.currentMembers >= billing.maxMembers ? "!bg-red-500" : ""}`}
                    style={{
                      width: `${Math.min(
            ...
            {billing.plan === "PRO" ? (
              ...
              <div className="space-y-3">
                <div className="rounded-lg border border-dashed border-violet-300 dark:border-violet-700 bg-violet-50/50 dark:bg-violet-950/20 p-4 space-y-2">
                  ...
                  <p className="text-sm text-muted-foreground">
                    Add unlimited members to your workspace. Free plan allows up to {billing.maxMembers} members.
                  </p>
                </div>
                <Button
                  size="sm"
